...
__all__ = ['forward_hook', 'Clone', 'Add', 'Cat', 'ReLU', 'Dropout', 'BatchNorm2d', 'Linear', 'MaxPool2d',
           'AdaptiveAvgPool2d', 'AvgPool2d', 'Conv2d', 'Sequential', 'safe_divide','BatchNorm3d','Conv3d','MaxPool3d',
           'AdaptiveAvgPool3d', 'Timedistributed', 'InstanceNorm3d']
...
class InstanceNorm3d(nn.InstanceNorm3d, RelProp):
    pass
